#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Quermesse Bar — Bom Retiro.
Uso: python3 fetch_quermesse_bom_retiro.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/quermesse-bom-retiro"
META_ACCOUNT   = "act_2101384330709220"
GADS_CUSTOMER  = "1016781796"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Quermesse Bar — Bom Retiro")
    ...
    data = {"cliente":"Quermesse Bar — Bom Retiro","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
