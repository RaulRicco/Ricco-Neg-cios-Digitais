#!/usr/bin/env python3
"""
Coleta dados para o dashboard de FishMe Bar e Cozinha.
Uso: python3 fetch_fish_me.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/fish-me"
META_ACCOUNT   = "act_488123552728918"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para FishMe Bar e Cozinha")
    ...
    data = {"cliente":"FishMe Bar e Cozinha","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":None,
