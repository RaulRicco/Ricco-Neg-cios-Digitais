#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Bebedouro Bar e Fogo — 356.
Uso: python3 fetch_bebedouro_356.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/bebedouro-356"
META_ACCOUNT   = "act_904480561216184"
GADS_CUSTOMER  = "8595847876"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Bebedouro Bar e Fogo — 356")
    ...
    data = {"cliente":"Bebedouro Bar e Fogo — 356","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
