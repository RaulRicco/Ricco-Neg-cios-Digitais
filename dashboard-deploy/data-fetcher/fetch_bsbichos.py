#!/usr/bin/env python3
"""
Coleta dados para o dashboard de BsBichos PetShop.
Uso: python3 fetch_bsbichos.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/bsbichos"
META_ACCOUNT   = "act_237794567104760"
GADS_CUSTOMER  = "3754202756"
GA4_PROPERTY   = "520104020"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para BsBichos PetShop")
    ...
    data = {"cliente":"BsBichos PetShop","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
