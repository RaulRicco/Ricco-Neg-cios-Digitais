#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Porks Três Lagoas.
Uso: python3 fetch_porks_tres_lagoas.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/porks-tres-lagoas"
META_ACCOUNT   = "act_3654839554842218"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Porks Três Lagoas")
    ...
    data = {"cliente":"Porks Três Lagoas","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":None,
