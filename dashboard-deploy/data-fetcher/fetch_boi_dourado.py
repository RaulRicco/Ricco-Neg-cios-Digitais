#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Churrascaria Boi Dourado.
Uso: python3 fetch_boi_dourado.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/boi-dourado"
META_ACCOUNT   = "act_167436168170959"
GADS_CUSTOMER  = "1865208256"
GA4_PROPERTY   = "404994582"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Churrascaria Boi Dourado")
    ...
    data = {"cliente":"Churrascaria Boi Dourado","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
