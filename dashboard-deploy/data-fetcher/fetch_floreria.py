#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Floreria Café.Bar.
Uso: python3 fetch_floreria.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/floreria"
META_ACCOUNT   = "act_1472457341555059"
GADS_CUSTOMER  = "1352930078"
GA4_PROPERTY   = "530189853"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Floreria Café.Bar")
    ...
    data = {"cliente":"Floreria Café.Bar","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
