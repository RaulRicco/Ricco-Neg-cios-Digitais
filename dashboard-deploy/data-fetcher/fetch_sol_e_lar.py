#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Casas Sol e Lar.
Uso: python3 fetch_sol_e_lar.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/sol-e-lar"
META_ACCOUNT   = "act_1172090764712996"
GA4_PROPERTY   = "489225528"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Casas Sol e Lar")
    ...
    data = {"cliente":"Casas Sol e Lar","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":ga4,
