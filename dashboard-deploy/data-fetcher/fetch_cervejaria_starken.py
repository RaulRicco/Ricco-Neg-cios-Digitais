#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Cervejaria Starken.
Uso: python3 fetch_cervejaria_starken.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/cervejaria-starken"
META_ACCOUNT   = "act_1020477143904346"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Cervejaria Starken")
    ...
    data = {"cliente":"Cervejaria Starken","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":None,
