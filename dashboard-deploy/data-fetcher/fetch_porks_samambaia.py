#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Porks Samambaia.
Uso: python3 fetch_porks_samambaia.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/porks-samambaia"
META_ACCOUNT   = "act_1035595840205318"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Porks Samambaia")
    ...
    data = {"cliente":"Porks Samambaia","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":ga4,
