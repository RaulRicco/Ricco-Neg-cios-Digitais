#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Hórus Treinamento Físico.
Uso: python3 fetch_horus.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/horus"
META_ACCOUNT   = "act_3330829303888399"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Hórus Treinamento Físico")
    ...
    data = {"cliente":"Hórus Treinamento Físico","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":None,
