#!/usr/bin/env python3
"""
Coleta dados para o dashboard de O Quintal Piri.
Uso: python3 fetch_quintal_piri.py --start 2026-04-01 --end 2026-04-30
"""
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para O Quintal Piri")
    ...
    data = {"cliente":"O Quintal Piri","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":None,
