#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Dog do Cangaceiro.
Uso: python3 fetch_dog_do_cangaceiro.py --start 2026-05-01 --end 2026-05-31
"""
...
OUT_DIR      = Path(__file__).parent.parent / "pages/dog-do-cangaceiro"
META_ACCOUNT = "act_992634901374560"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Dog do Cangaceiro")
    ...
    data = {"cliente":"Dog do Cangaceiro","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
