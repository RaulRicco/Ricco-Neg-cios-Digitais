#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Porks Castelo.
Uso: python3 fetch_porks_castelo.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/porks-castelo"
META_ACCOUNT   = "act_735816737938125"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Porks Castelo")
    ...
    data = {"cliente":"Porks Castelo","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":None,
