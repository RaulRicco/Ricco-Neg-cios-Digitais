#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Dona Cleide — Sabor Caseiro.
Uso: python3 fetch_dona_cleide.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/dona-cleide"
META_ACCOUNT   = "act_633829687993340"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Dona Cleide — Sabor Caseiro")
    ...
    data = {"cliente":"Dona Cleide — Sabor Caseiro","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":None,
