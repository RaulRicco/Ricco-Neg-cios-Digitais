#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Seu Barbudo Barbearia.
Uso: python3 fetch_seu_barbudo.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/seu-barbudo"
META_ACCOUNT   = "act_453553515121883"
GA4_PROPERTY   = "529874845"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Seu Barbudo Barbearia")
    ...
    data = {"cliente":"Seu Barbudo Barbearia","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":ga4,
