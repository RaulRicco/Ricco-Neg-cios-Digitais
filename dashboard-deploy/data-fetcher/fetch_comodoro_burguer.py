#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Comodoro Burguer.
...
OUT_DIR = Path(__file__).parent.parent / "pages/comodoro-burguer"
META_ACCOUNT   = "act_4617297935009077"
GADS_CUSTOMER  = "9692643691"
GA4_PROPERTY   = "321208123"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Comodoro Burguer")
    ...
    data = {"cliente":"Comodoro Burguer","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
