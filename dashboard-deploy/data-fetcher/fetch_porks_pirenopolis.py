#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Porks Pirenópolis.
Uso: python3 fetch_porks_pirenopolis.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/porks-pirenopolis"
META_ACCOUNT   = "act_278928591684240"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Porks Pirenópolis")
    ...
    data = {"cliente":"Porks Pirenópolis","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":None,
