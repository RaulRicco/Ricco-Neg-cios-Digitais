#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Ameriparts Três Lagoas.
Uso: python3 fetch_ameriparts.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/ameriparts"
META_ACCOUNT   = "act_476310531948549"
GADS_CUSTOMER  = "5463346413"
GA4_PROPERTY   = "528472800"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Ameriparts Três Lagoas")
    ...
    data = {"cliente":"Ameriparts Três Lagoas","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
