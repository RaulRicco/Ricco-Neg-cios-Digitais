#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Bar do Açougueiro — Batel.
Uso: python3 fetch_acougueiro_batel.py --start 2026-04-01 --end 2026-04-30
"""
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Bar do Açougueiro — Batel")
    ...
    data = {"cliente":"Bar do Açougueiro — Batel","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
