#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Solar e Cia.
Uso: python3 fetch_solar_e_cia.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/solar-e-cia"
META_ACCOUNT   = "act_9235631696487359"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Solar e Cia")
    ...
    data = {"cliente":"Solar e Cia","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":None,
