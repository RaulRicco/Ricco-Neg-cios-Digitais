#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Burger Garage.
Uso: python3 fetch_garage_burger.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/garage-burger"
META_ACCOUNT   = "act_556754907414470"
GA4_PROPERTY   = "527512899"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Burger Garage")
    ...
    data = {"cliente":"Burger Garage","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":ga4,
