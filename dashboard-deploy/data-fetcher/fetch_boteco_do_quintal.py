#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Boteco do Quintal.
Uso: python3 fetch_boteco_do_quintal.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/boteco-do-quintal"
META_ACCOUNT   = "act_1437070783628710"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Boteco do Quintal")
    ...
    data = {"cliente":"Boteco do Quintal","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":None,
