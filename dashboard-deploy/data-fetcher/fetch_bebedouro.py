#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Bebedouro Bar e Fogo.
Uso: python3 fetch_bebedouro.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/bebedouro"
META_ACCOUNT   = "act_904480561216184"
GADS_CUSTOMER  = "6755763415"
GA4_PROPERTY   = "527345752"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Bebedouro Bar e Fogo")
    ...
    data = {"cliente":"Bebedouro Bar e Fogo","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
