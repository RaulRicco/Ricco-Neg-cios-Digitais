#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Bar do Açougueiro — Bacacheri.
Uso: python3 fetch_acougueiro_bacacheri.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/acougueiro-bacacheri"
META_ACCOUNT   = "act_1449387792808479"
GADS_CUSTOMER  = "1098008121"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Bar do Açougueiro — Bacacheri")
    ...
    data = {"cliente":"Bar do Açougueiro — Bacacheri","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
