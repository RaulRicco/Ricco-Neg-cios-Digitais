#!/usr/bin/env python3
"""
Coleta dados para o dashboard de Porks Casarão.
Uso: python3 fetch_porks_casarao.py --start 2026-04-01 --end 2026-04-30
"""
...
OUT_DIR = Path(__file__).parent.parent / "pages/porks-casarao"
META_ACCOUNT   = "act_1721342555031533"
...
def main():
    parser = argparse.ArgumentParser(description="Coleta dados para Porks Casarão")
    ...
    data = {"cliente":"Porks Casarão","periodo":{"start":start,"end":end},"gerado_em":datetime.now().isoformat(),
        "consolidado":None,
        "meta":meta,
        "google":None,
        "ga4":None,
